...
function drawBarChart(d_obj, id_div) 
{
	...
	var wo_per_state_data = google.visualization.arrayToDataTable([
		[${P_quoted(i18n('column_id1', 'Statut'))}, ${P_quoted(i18n('column_text_id1', 'Nombre'))}, { role: 'annotation' }, { role: 'style' }],
		[${P_quoted(i18n('column_id2', 'Transmis'))}, d_obj.nb_draf, d_obj.nb_draf, yelCol],					// 'Awaiting Diagnosis'
		[${P_quoted(i18n('column_id3', 'En attente de diagnostic'))}, d_obj.nb_aw, d_obj.nb_aw, yelCol],		// 'Awaiting Diagnosis'
		[${P_quoted(i18n('column_id4', 'Diagnostiqué'))}, d_obj.nb_diag, d_obj.nb_diag, bluCol],				// 'Diagnosed'
		[${P_quoted(i18n('column_id5', 'Affecté'))}, d_obj.nb_ass, d_obj.nb_ass, bluCol],					// 'Assigned'
		[${P_quoted(i18n('column_id6', 'En cours de résolution'))}, d_obj.nb_work, d_obj.nb_work, bluCol],	// 'Work In Progress'
		[${P_quoted(i18n('column_id7', 'Terminé - Complet'))}, d_obj.nb_fcom, d_obj.nb_fcom, greCol],		// 'Finished - Complete'
		[${P_quoted(i18n('column_id8', 'Terminé - Incomplet'))}, d_obj.nb_finc, d_obj.nb_finc, redCol],		// 'Finished - Incomplete'
		[${P_quoted(i18n('column_id9', 'Annulé'))}, d_obj.nb_canc, d_obj.nb_canc, bluCol],					// 'Cancelled'
		[${P_quoted(i18n('column_id10', 'Erreur'))}, d_obj.nb_err, d_obj.nb_err, redCol],					// 'Error'
