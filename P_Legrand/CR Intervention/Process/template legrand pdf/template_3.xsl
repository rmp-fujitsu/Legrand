                ...
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <!-- Entête 1ère page -->
                        <fo:marker marker-class-name="first-page-header" 
                            ...
                            <!-- <xsl:call-template name="Bandeau_logos" /> -->
...
<!-- Bloc de séparation -->
                        <fo:block space-after="60pt" space-after.conditionality="retain" line-height="1.147">
                            <fo:leader />
                        </fo:block>

<!-- Titre de page -->
                        <fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="11pt" language="FR" font-weight="bold" text-align="center">
...
<!-- Bandeau Logos Entête 1ère page -->
    <xsl:template name="Bandeau_logos">
