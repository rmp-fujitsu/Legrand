...
<!-- Table General Information -->
                        <fo:table font-family="Arial" language="FR" start-indent="0pt" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt" 
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags">
                            <fo:table-column column-number="1" column-width="71pt" />
                            <fo:table-column column-number="2" column-width="62pt" />
                            <fo:table-column column-number="3" column-width="99pt" />
                            <fo:table-column column-number="4" column-width="104pt" />
                            <fo:table-column column-number="5" column-width="86pt" />
                            <fo:table-column column-number="6" column-width="86pt" />
                            <fo:table-body start-indent="0pt" end-indent="0pt">
                                <fo:table-row text-align="center">
                                    ...
                                    <fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" number-columns-spanned="2" background-color="#FFFFFF" display-align="center">
                                        <fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="8pt" language="FR">
                                            <fo:inline font-family="Arial" font-size="8pt" font-weight="bold">
                                                <fo:leader leader-length="0pt" />
                                                <xsl:value-of select="location_info_site_name"/> - <xsl:value-of select="location_info_country"/>
                                            </fo:inline>
                                        </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#FFFFFF" display-align="center">
                            ...
                            <fo:table-body start-indent="0pt" end-indent="0pt">
                                <fo:table-row text-align="center">
                                    <fo:table-cell padding-top="1pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" number-columns-spanned="4" background-color="#FF0000" display-align="center">
                                        <fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="12pt" language="FR" font-weight="bold">
                                            <fo:inline font-family="Arial" font-weight="bold" color="#FFFFFF" font-size="14pt">
                                                <fo:leader leader-length="0pt" />Tests with the user
                                            </fo:inline>
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
