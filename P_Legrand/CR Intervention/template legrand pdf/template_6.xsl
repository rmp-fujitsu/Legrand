...
<!-- Root document -->
        <fo:root font-family="Arial" 
            ...
            <fo:layout-master-set xmlns:rx="http://www.renderx.com/XSL/Extensions" 
                ...
                <fo:simple-page-master master-name="section1-first-page" page-width="8.268055555555555in" page-height="11.693055555555556in" margin-top="15pt" margin-bottom="15pt" margin-right="55pt" margin-left="45pt">
                ...
                <fo:simple-page-master master-name="section1-odd-page" page-width="8.268055555555555in" page-height="11.693055555555556in" margin-top="20pt" margin-bottom="15pt" margin-right="55pt" margin-left="45pt">
                    <fo:region-body margin-top="0pt" margin-bottom="10pt"></fo:region-body>
                ...
                <fo:simple-page-master master-name="section1-even-page" page-width="8.268055555555555in" page-height="11.693055555555556in" margin-top="20pt" margin-bottom="15pt" margin-right="55pt" margin-left="45pt">
                    <fo:region-body margin-top="0pt" margin-bottom="10pt"></fo:region-body>
...
<!-- Bandeau Logos -->
                        <fo:table xmlns:st1="urn:schemas-microsoft-com:office:smarttags" font-family="Arial" language="FR" start-indent="0pt" border-style="none" >
                            <fo:table-column column-number="1" column-width="255px"/>
                            <fo:table-column column-number="2" column-width="255px"/>
                            <fo:table-body start-indent="0pt" end-indent="0pt">
                                <fo:table-row text-align="center">
                                    <fo:table-cell text-align="left" padding="5.4pt" border-style="none" display-align="after">
                                        <fo:block>
                                            <xsl:call-template name="Logo_Legrand" />
                                        </fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell text-align="right" padding="5.4pt" border-style="none" display-align="after">
                                        <fo:block>
                                            <xsl:call-template name="Logo_Fujitsu" />
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                            </fo:table-body>
...
<!-- User Data Backup -->                          
                        <fo:table font-family="Arial" language="FR" start-indent="0pt" text-align="center" border-top-style="solid" border-top-color="black" border-top-width="0.5pt" border-left-style="solid" border-left-color="black" border-left-width="0.5pt" border-bottom-style="solid" border-bottom-color="black" border-bottom-width="0.5pt" border-right-style="solid" border-right-color="black" border-right-width="0.5pt" 
                            xmlns:st1="urn:schemas-microsoft-com:office:smarttags">
                            <fo:table-column column-number="1" column-width="127pt" />
                            <fo:table-column column-number="2" column-width="127pt" />
                            <fo:table-column column-number="3" column-width="127pt" />
                            <fo:table-column column-number="4" column-width="127pt" />
                            <fo:table-body start-indent="0pt" end-indent="0pt">
                                <fo:table-row text-align="center">
                                    <fo:table-cell padding-top="1pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" number-columns-spanned="4" background-color="#FF0000" display-align="center">
                                        <fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="12pt" language="FR" font-weight="bold">
                                            <fo:inline font-family="Arial" font-weight="bold" color="#FFFFFF" font-size="14pt">
                                                <fo:leader leader-length="0pt" />User Data Backup
                                            </fo:inline>
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row text-align="left">
                                    <fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" number-columns-spanned="4" background-color="#FFFFFF">
                                        <fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="10pt" language="EN-US" font-weight="bold">
                                            ...
                                            <fo:inline font-family="Arial" font-weight="bold" font-size="8pt" language="EN-US">
                                                <fo:block />
                                                <fo:leader leader-length="0pt" />If not possible for now, use an external hard drive. </fo:inline>
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row text-align="left">
                                    ...
                                    <fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#FFFFFF" display-align="center">
                                        <fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="8pt" language="EN-US">
                                            ...
                                            <fo:inline font-family="Arial" font-size="8pt" language="EN-US">
                                                <fo:leader leader-length="0pt" />Office templates</fo:inline>
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row text-align="left">
                            ...
                            <fo:table-body start-indent="0pt" end-indent="0pt">
                                <fo:table-row text-align="center">
                                    <fo:table-cell padding-top="1pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" number-columns-spanned="4" background-color="#FF0000" display-align="center">
                                        <fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="12pt" language="FR" font-weight="bold">
                                            <fo:inline font-family="Arial" font-weight="bold" color="#FFFFFF" font-size="14pt">
                                                <fo:leader leader-length="0pt" />PC Configuration
                                            </fo:inline>
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row text-align="left">
                                    ...
                                    <fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#FFFFFF" display-align="center">
                                        <fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="8pt" language="EN-US">
                                            ...
                                            <fo:inline font-family="Arial" font-size="8pt" language="EN-US">
                                                <fo:leader leader-length="0pt" />Software configuration (if required) </fo:inline>
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row text-align="left">
                                    ...
                                    <fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#FFFFFF" display-align="center">
                                        <fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="8pt" language="EN-US">
                                            ...
                                            <fo:inline font-family="Arial" font-size="8pt" language="EN-US">
                                                <fo:leader leader-length="0pt" />Skype</fo:inline>
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row text-align="left">
                            ...
                            <fo:table-body start-indent="0pt" end-indent="0pt">
                                <fo:table-row text-align="center">
                                    <fo:table-cell padding-top="1pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" number-columns-spanned="4" background-color="#FF0000" display-align="center">
                                        <fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="12pt" language="FR" font-weight="bold">
                                            <fo:inline font-family="Arial" font-weight="bold" color="#FFFFFF" font-size="14pt">
                                                <fo:leader leader-length="0pt" />Test with the user
                                            </fo:inline>
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                ...
                                <fo:table-row text-align="left">
                                    ...
                                    <fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#FFFFFF" display-align="center">
                                        <fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="8pt" language="EN-US">
                                            ...
                                            <fo:inline font-family="Arial" font-size="8pt" language="EN-US">
                                                <fo:leader leader-length="0pt" />Printing test (user’s default printer)</fo:inline>
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <fo:table-row text-align="left">
                            ...
                            <fo:table-body start-indent="0pt" end-indent="0pt">
                                <fo:table-row text-align="center">
                                    <fo:table-cell padding-top="1pt" padding-left="5.4pt" padding-bottom="0pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" number-columns-spanned="4" background-color="#FF0000" display-align="center">
                                        <fo:block space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="12pt" language="FR" font-weight="bold">
                                            <fo:inline font-family="Arial" font-weight="bold" color="#FFFFFF" font-size="14pt">
                                                <fo:leader leader-length="0pt" />CMDB Database Information
                                            </fo:inline>
                                        </fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                ...
                                <fo:table-row text-align="left">
                                    ...
                                    <fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#FFFFFF" display-align="center">
                                        <fo:block text-align="left" space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="8pt" language="EN-US" font-weight="bold">
                                ...
                                <fo:table-row text-align="left">
                                    ...
                                    <fo:table-cell padding-top="5pt" padding-left="5.4pt" padding-bottom="5pt" padding-right="5.4pt" border-left-style="solid" border-right-style="solid" border-left-color="black" border-right-color="black" border-left-width="0.25pt" border-right-width="0.25pt" border-top-style="solid" border-bottom-style="solid" border-top-color="black" border-bottom-color="black" border-top-width="0.25pt" border-bottom-width="0.25pt" background-color="#FFFFFF" display-align="center">
                                        <fo:block text-align="left" space-after="0pt" space-after.conditionality="retain" line-height="1.147" font-family="Arial" font-size="8pt" language="EN-US">
...
<!-- Template: affiche CheckBox_On_Off selon valeur -->
    <xsl:template name = "select_CheckBox" >
...
<!-- Template: affiche RadioButton_On_Off selon si windows 7 ou windows 10 selectionné -->
    <xsl:template name = "set_version_radiobutton" >
        <xsl:param name = "radiobutton_current_value_wind7" />
        <xsl:param name = "radiobutton_current_value_wind10" />
        <xsl:param name = "radiobutton_new_value_wind7" />
        <xsl:param name = "radiobutton_new_value_wind10" />
        <xsl:choose>
            <xsl:when test="$radiobutton_current_value_wind7 = 'windows7'"> 
                <xsl:call-template name="RadioButton_On" />
            </xsl:when>
            <xsl:when test="$radiobutton_current_value_wind10 = 'windows10'">
                <xsl:call-template name="RadioButton_On" />
            </xsl:when>
            <xsl:when test="$radiobutton_new_value_wind7 = 'windows7'">
                <xsl:call-template name="RadioButton_On" />
            </xsl:when>
            <xsl:when test="$radiobutton_new_value_wind10 = 'windows10'">
                <xsl:call-template name="RadioButton_On" />
            </xsl:when>
            <xsl:otherwise>
                <xsl:call-template name="RadioButton_Off" />
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
...
<!-- Icône Case NON cochée -->
    <xsl:template name="CheckBox_Off">
        <fo:inline>
...
<!-- Icône Bouton Radio activé -->
    <xsl:template name="RadioButton_On">
        <fo:inline>
...
<!-- Icône Bouton Radio NON activé -->
    <xsl:template name="RadioButton_Off">
        <fo:inline>
