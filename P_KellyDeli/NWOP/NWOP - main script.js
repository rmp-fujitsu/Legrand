            ...
            case "LOCAL" :
                ...
                if ( (location_code_value !== "tous") && (!isEmpty(location_code_value)) ) {
                    ...
                    if (!(isEmpty(kiosk_list))) {       // Regional Manager manages several kiosks
                        ...
                        // console.log("getFilteredLocations : kiosk_list_array = ", kiosk_list_array);
...
function load_next_screen(n_interface)
{
    ...
    var url = "https://live.runmyprocess.com/live/112501480325272109/appli/" + n_interface + "?P_mode=${P_mode}&P_language=${P_language}&location_code="
