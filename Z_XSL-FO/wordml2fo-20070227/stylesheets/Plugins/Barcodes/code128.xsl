...
<!-- ========================================================= -->
    ...
    <xsl:template name="barcode-code128">
      ...
      <xsl:variable name="value-encoded">
        <xsl:call-template name="recursive-coder-code128">
      ...
      <xsl:call-template name="draw-barcode-code128">
    ...
    <xsl:template name="recursive-coder-code128">
      <xsl:param name="value"/>
      ...
      <xsl:variable name="char">
        <xsl:choose>
          ...
          <xsl:when test="$subset='C'">
        	...
        	<!-- Attention! If you use @char attribute value (also for searching), you should take into consideration fact that character '{'  is replaced with '&#x2983;' and '}' - with '&#x2984;' ! -->
        	<!-- For specification compliance reason curly brackets were replaced with "white" curly brackets in code table. -->
