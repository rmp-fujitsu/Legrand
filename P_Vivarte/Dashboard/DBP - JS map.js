...
function initMap()
{
    ...
    var hq_vivarte = {lat: 48.889975, lng: 2.371302};       // Vivarte HeadQuarter coordinates
...
function dispatchWorkOrder()
{
    ...
    if ( (wos_array.length == undefined) || (wos_array.length == 0) ) {
        RMPApplication.showErrorBox ("Information", "Aucun incident associé à un SLA, est en cours !");
...
function showMarkers(arr_loc) 
{
    ...
    if ( (arr_loc.length == undefined) || (arr_loc.length == 0) ) {
        RMPApplication.showErrorBox ("Information", "Aucun incident en cours n'est concerné par ce statut de SLA!");
        return;
    }
    ...
    var siteInfo =    
        '<div id="content' + w_order_arr.wo_list[0].loc_col_location_code + '">' +
            '<div id="siteNotice' + w_order_arr.wo_list[0].loc_col_location_code + '">' +
                '<img src="https://live.runmyprocess.com/live/112501480325272109/upload/6db38a30-dbe7-11e6-9088-02b3a23437c9/locations_200.png" height="35">' +
                ...
                '<div id="contentSite_' + w_order_arr.wo_list[0].loc_col_location_code + '" class="content_infoWindowMap">' +
                   ...
                   w_order_arr.wo_list[0].loc_zip + '  ' + w_order_arr.wo_list[0].loc_city.toUpperCase()  + '<br>' + 
                    ...
                    '<hr>' + 
                    '<p><strong>Incidents en cours (Etat SLA)</strong></p>';
