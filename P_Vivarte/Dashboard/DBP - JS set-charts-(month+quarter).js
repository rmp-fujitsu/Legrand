...
function drawChart()
{
	...
	// Following CAPI is only implemented for 2 periods (current & previous month-quarter)
	id_get_report_datas_mq_version_api.trigger(wo_query, options, wo_list_ok, wo_list_ko);
