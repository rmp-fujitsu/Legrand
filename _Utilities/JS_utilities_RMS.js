...
function showNotif(msg, hide)
{
	if(msg!="runmyprocess") {
		id_html_msg.setHtml('<div class="notify"><span class="icon"></span><p>'+msg +'</p></div>');
		if(hide) {
			$(document).ready(function() {
				$(".notify").css('display','none').delay(500).show("slide", { direction: "right" },500).delay(5500).hide("slide", { direction: "right" },500);
				$(".notify").hover(function() {
					$(this).stop(true,true).fadeIn();
				},function() {
					$(this).stop(true,true).delay(500).show("slide", { direction: "right" },500).delay(5500).hide("slide", { direction: "right" },500);
				});
			});
	 	} else {
		   	$(document).ready(function() {
				$(".notify").css('display','none').delay(500).show("slide", { direction: "right" },500);
		   		$(".notify").hover(function() {
		    		$(this).stop(true,true).fadeIn();
		   		},function() {
		    			$(this).stop(true,true).delay(500).show("slide", { direction: "right" },500).delay(5500);
	   			});
	   		});
	 	}
	 }
...
function hideNotif()
{
	id_html_msg.setHtml('<div class="notify"><span class="icon"></span><p></p></div>');
	$(document).ready(function() {
...
function getDateWithTime(timestamp_in_millisec) 
{
...
function getDateWithoutTime(timestamp_in_millisec) 
{
    var today = new Date(timestamp_in_millisec);
    var dd = today.getDate();
    var mm = today.getMonth() + 1;  //January is 0!
